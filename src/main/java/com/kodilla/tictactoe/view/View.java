...
public class View implements IView{
    ...
    public void displayBoard() {
        ...
        for (IBoardCell cell : board.getBoardCells()) {
            switch (cell.getCellStatus()) {
                case TAKEN_BY_X -> displayBoard[cell.getXCoordinate()][cell.getYCoordinate()] = "X";
                case TAKEN_BY_Y -> displayBoard[cell.getXCoordinate()][cell.getYCoordinate()] = "O";
                case EMPTY -> displayBoard[cell.getXCoordinate()][cell.getYCoordinate()] = " ";
            }
        }
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
    ...
    public int[] takePlayerInput() {
        ...
        try {
            ...
            if (gameService.getBoard().getBoardCell(x, y).getCellStatus() != CellStatus.EMPTY) {
